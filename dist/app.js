...
function renderHistory(){
  ...
  for(const item of history){
    ...
    for(const [i,e] of Object.entries(item.session?.exercises || {})){
      const exercise=plans[item.workout]?.items[i] || {name:'Exercise',unit:'reps'};
